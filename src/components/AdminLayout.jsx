...
import { BookOpen, LayoutDashboard, Bell, FileText, Newspaper, FileArchive, LogOut, Bot, Activity, ListChecks, ClipboardList } from 'lucide-react'
import toast from 'react-hot-toast'

const adminLinks = [
  { to: '/admin', icon: LayoutDashboard, label: 'Dashboard' },
  { to: '/admin/drafts', icon: Bot, label: 'AI Drafts' },
  { to: '/admin/questions', icon: ListChecks, label: 'Question Bank' },
  { to: '/admin/mock-tests', icon: ClipboardList, label: 'Mock Tests' },
  { to: '/admin/automation', icon: Activity, label: 'Automation' },
